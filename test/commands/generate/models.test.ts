...
describe('models', () => {
  ...
  describe('for C#', () => {  
    ...
    test
      .stderr()
      .stdout()
      .command([...generalOptions, 'csharp', './test/specification.yml', `-o=${ path.resolve(outputDir, './csharp')}`, '--no-log-diagnostics'])
  ...
  describe('for Java', () => {  
    ...
    test
      .stderr()
      .stdout()
      .command([...generalOptions, 'java', './test/specification.yml', `-o=${ path.resolve(outputDir, './java')}`, '--no-log-diagnostics'])
  ...
  describe('for Go', () => {  
    ...
    test
      .stderr()
      .stdout()
      .command([...generalOptions, 'golang', './test/specification.yml', `-o=${ path.resolve(outputDir, './go')}`, '--no-log-diagnostics'])
      .it('fails when no package defined', (ctx, done) => {
  ...
  describe('for Dart', () => {  
    ...
    test
      .stderr()
      .stdout()
      .command([...generalOptions, 'dart', './test/specification.yml', `-o=${ path.resolve(outputDir, './dart')}`, '--no-log-diagnostics'])
      .it('fails when no package defined', (ctx, done) => {
